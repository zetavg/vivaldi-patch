...
sed 's/class K extends(Object(y.Record)({type:"tab",id:"",page:new r.a})){}/class K extends(Object(y.Record)({type:"tab",id:"",page:new r.a,subtab:false})){};window.TabDataClass=K;/' | \
